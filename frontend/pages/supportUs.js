    ...
    render() {
        return (
            <Container>
                ...
                <p>We want to make Ours to Save <span className="green">the best it can be</span> – to make the climate crisis tangible and prove that it’s solvable if we approach it together. In keeping with this, we’ll be  keeping the entirety of our website free while we all weather the worst of the coronavirus pandemic. In around July, we’ll introduce a small subscription fee for access to the news page. <span className="green">The map will always be free for all.</span></p>
                ...
                <p>Thank you - we won’t be able to do it without you.</p>
                <p>Florence & Harry</p>
