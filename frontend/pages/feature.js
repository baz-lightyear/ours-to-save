...
class feature extends Component {
    static async getInitialProps(ctx) {
        ...
        const res = await fetch(`${url}`, {
            ...
            body: JSON.stringify({ query: `{ feature(id: "${id}") { id title subtitle createdAt author bio content featuredImage latitude longitude category alwaysFree comments { id createdAt approved content author { name }}}}` }),
        })
