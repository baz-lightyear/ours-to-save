        ...
        return (
            <Container>
                <div className="text">
                    ...
                    <Link href={{pathname: '/feature', query: { id: this.props.feature.id, title: this.props.feature.title, subtitle: this.props.feature.subtitle, image: this.props.feature.paragraphs[0].image }}}><h2><a>{this.props.feature.title}</a></h2></Link>    
